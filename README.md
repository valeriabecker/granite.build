...
- [Granite.Build](#granitebuild)
  ...
  - [Web Dashboard](#web-dashboard)
    - [Mode 1 — Standalone (default, recommended)](#mode-1--standalone-default-recommended)
    - [Mode 2 — Dev server (hot reload)](#mode-2--dev-server-hot-reload)
    - [Mode 3 — Remote gbserver](#mode-3--remote-gbserver)
